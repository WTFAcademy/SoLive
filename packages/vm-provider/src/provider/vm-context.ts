/* global ethereum */
'use strict'
import { hash , execution } from '@remix-project/remix-lib'
import { bufferToHex , bigIntToHex } from '@ethereumjs/util'
import type { Address } from '@ethereumjs/util'
import { decode } from 'rlp'
import { ethers } from 'ethers'
const { LogsManager } = execution
import { VM , EEI } from '@ethereumjs/vm'
...
export class VMContext {
  ...
  currentVm: CurrentVm | undefined
  web3vm: VmProxy | undefined
  logsManager: any // LogsManager
  exeResults: Record<string, Transaction>
  nodeUrl: string | undefined
  blockNumber: number | "latest" | undefined
