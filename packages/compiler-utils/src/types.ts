...
// homestead：以太坊主网上线时所使用的 EVM 版本。
// tangerineWhistle：以太坊的第四个硬分叉（EIP 150）引入的 EVM 版本。
// spuriousDragon：以太坊的第五个硬分叉（EIP 155）引入的 EVM 版本。
// byzantium：以太坊的第六个硬分叉（EIP 609）引入的 EVM 版本。
// constantinople：以太坊的第七个硬分叉（EIP 1013）引入的 EVM 版本。
// petersburg：以太坊的第八个硬分叉（EIP 1283）引入的 EVM 版本。
// istanbul：以太坊的第九个硬分叉（EIP 1679）引入的 EVM 版本。
