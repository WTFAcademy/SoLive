...
const config = {
  title: "SoLive",
  tagline: "SoLive is the first open-source lightweight Solidity Integrated Development Environment (IDE) that can be integrated into websites, documents, and tutorials easily. Powered by WTF Academy, Inspired by Remix-IDE and react-live.",
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} SoLive, Inc. Built by WTF Academy.`,
      },
      prism: {
